...
__attribute__ ((interrupt)) void exc8(interruptFrame* frame, qword error){kpanic(fprintf("%s\nCODE: %x\nRIP: %x\nCS: %x\nrFLAGS: %x\nSP: %x\nSS: %x", exceptionsList[8], error, frame->instructionPointer, frame->codeSegment, frame->rFlags, frame->stackPointer, frame->stackSegment));};
__attribute__ ((interrupt)) void exc10(interruptFrame* frame, qword error){kpanic(fprintf("%s\nCODE: %x\nRIP: %x\nCS: %x\nrFLAGS: %x\nSP: %x\nSS: %x", exceptionsList[10], error, frame->instructionPointer, frame->codeSegment, frame->rFlags, frame->stackPointer, frame->stackSegment));};
__attribute__ ((interrupt)) void exc11(interruptFrame* frame, qword error){kpanic(fprintf("%s\nCODE: %x\nRIP: %x\nCS: %x\nrFLAGS: %x\nSP: %x\nSS: %x", exceptionsList[11], error, frame->instructionPointer, frame->codeSegment, frame->rFlags, frame->stackPointer, frame->stackSegment));};
__attribute__ ((interrupt)) void exc12(interruptFrame* frame, qword error){kpanic(fprintf("%s\nCODE: %x\nRIP: %x\nCS: %x\nrFLAGS: %x\nSP: %x\nSS: %x", exceptionsList[12], error, frame->instructionPointer, frame->codeSegment, frame->rFlags, frame->stackPointer, frame->stackSegment));};
__attribute__ ((interrupt)) void exc13(interruptFrame* frame, qword error){kpanic(fprintf("%s\nCODE: %x\nRIP: %x\nCS: %x\nrFLAGS: %x\nSP: %x\nSS: %x", exceptionsList[13], error, frame->instructionPointer, frame->codeSegment, frame->rFlags, frame->stackPointer, frame->stackSegment));};
__attribute__ ((interrupt)) void exc14(interruptFrame* frame, qword error){kpanic(fprintf("%s\nCODE: %x\nRIP: %x\nCS: %x\nrFLAGS: %x\nSP: %x\nSS: %x", exceptionsList[14], error, frame->instructionPointer, frame->codeSegment, frame->rFlags, frame->stackPointer, frame->stackSegment));};
__attribute__ ((interrupt)) void exc17(interruptFrame* frame, qword error){kpanic(fprintf("%s\nCODE: %x\nRIP: %x\nCS: %x\nrFLAGS: %x\nSP: %x\nSS: %x", exceptionsList[17], error, frame->instructionPointer, frame->codeSegment, frame->rFlags, frame->stackPointer, frame->stackSegment));};
__attribute__ ((interrupt)) void exc21(interruptFrame* frame, qword error){kpanic(fprintf("%s\nCODE: %x\nRIP: %x\nCS: %x\nrFLAGS: %x\nSP: %x\nSS: %x", exceptionsList[21], error, frame->instructionPointer, frame->codeSegment, frame->rFlags, frame->stackPointer, frame->stackSegment));};
__attribute__ ((interrupt)) void exc29(interruptFrame* frame, qword error){kpanic(fprintf("%s\nCODE: %x\nRIP: %x\nCS: %x\nrFLAGS: %x\nSP: %x\nSS: %x", exceptionsList[29], error, frame->instructionPointer, frame->codeSegment, frame->rFlags, frame->stackPointer, frame->stackSegment));};
__attribute__ ((interrupt)) void exc30(interruptFrame* frame, qword error){kpanic(fprintf("%s\nCODE: %x\nRIP: %x\nCS: %x\nrFLAGS: %x\nSP: %x\nSS: %x", exceptionsList[30], error, frame->instructionPointer, frame->codeSegment, frame->rFlags, frame->stackPointer, frame->stackSegment));};
